...
DEFAULT_SWEEP_DATA = SCRIPT_DIR / "sweep_metrics4.csv"
DEFAULT_BREAKDOWN_DATA = SCRIPT_DIR / "pipeline_breakdown.csv"
DEFAULT_OUTPUT_DIR = SCRIPT_DIR / "output"

FAMILY_INFO = {
    ("BF16", 0): ("BF16", "#2E7BE5"),
    ("BF16", 1): ("BF16 + SAGE", "#E87500"),
    ("FP8_BLOCK", 0): ("FP8 blockwise", "#8A2BE2"),
    ("FP8_BLOCK", 1): ("FP8 blockwise + SAGE", "#198D47"),
    ("NVFP4", 0): ("NVFP4", "#D92D20"),
    ("NVFP4", 1): ("NVFP4 + SAGE", "#0D9488"),
}
FAMILY_ORDER = tuple(name for name, _ in FAMILY_INFO.values())
